...
#define CUBE_STRIDE CUBE_SIZEOF_VERTEX

//	Font vertices metadata
#define FONT_POS_OFFSET (void*)(0)
#define FONT_FLOATS_PER_POS (3)
#define FONT_NORMAL_OFFSET (void*)(sizeof(GLfloat)*FONT_FLOATS_PER_POS)
#define FONT_FLOATS_PER_NORMAL (3)
#define FONT_TEXTURE_OFFSET (void*)(sizeof(GLfloat)*(FONT_FLOATS_PER_NORMAL+FONT_FLOATS_PER_POS))
#define FONT_FLOATS_PER_TEXTURE (2)
#define FONT_FLOATS_PER_VERTEX (FONT_FLOATS_PER_NORMAL+FONT_FLOATS_PER_POS+FONT_FLOATS_PER_TEXTURE)
#define FONT_SIZEOF_VERTEX (sizeof(GLfloat)*FONT_FLOATS_PER_VERTEX)
#define FONT_STRIDE FONT_SIZEOF_VERTEX
